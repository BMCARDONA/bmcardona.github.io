...
Let's suppose for our training set that our input feature is ''house size'' and our output variable is ''house price.'' (Hence, each row or ''training instance'' corresponds to one given house). Our goal then is to describe the relationship between house size and house price. 
